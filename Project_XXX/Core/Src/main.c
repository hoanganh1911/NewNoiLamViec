...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LORA_NSS_Pin|LORA_RST_Pin|LORA_INT_Pin|NFC_SS_Pin
                          |NFC_INT_Pin|NFC_SSB15_Pin|RS485_DERE_Pin|TTP229_SCL_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LORA_NSS_Pin LORA_RST_Pin LORA_INT_Pin NFC_SS_Pin
                           NFC_INT_Pin NFC_SSB15_Pin RS485_DERE_Pin TTP229_SCL_Pin */
  ...
  /*Configure GPIO pin : TTP229_SDO_Pin */
